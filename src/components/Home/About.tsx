  ...
  <section className="about">
    <div>
      ...
      <p>
        ...
        mauris semper, elementum lobortis quam. Fusce a finibus nisl, id varius
        tortor. Suspendisse varius lacus nec ultrices tincidunt. Quisque id ex
        tortor. Donec tempus neque faucibus velit sagittis aliquam.
      </p>
    </div>
